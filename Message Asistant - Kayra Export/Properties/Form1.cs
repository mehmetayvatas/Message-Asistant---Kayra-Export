...
namespace Message_Asistant___Kayra_Export.Properties
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string anaKlasorYolu = @"\\10.1.10.6\towel\Genel\Mehmet\Mesajlar"; // Klasörlerin bulunduğu ana yol
        ...
        private void AramaVeKaydet(string klasorYolu, string hedefKlasorAdi, string dosyaAdi, string dosyaIcerik)
        {
            ...
            foreach (string altKlasor in altKlasorler)
            {
                ...
                {
                    string dosyaYolu = Path.Combine(altKlasor, dosyaAdi + ".txt"); // .txt uzantılı dosya oluştur
                    try
                    {
                        // Dosyayı aç ve içeriği ekleyerek kaydet
