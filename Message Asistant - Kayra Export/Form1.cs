...

{
    public partial class Form1 : Form
    {
        ...
        private List<string> orijinalOgeler2 = new List<string>();
        private Dictionary<string, string> dosyaBilgileri2 = new Dictionary<string, string>();
        private Timer directoryCheckTimer;
        ...
        public Form1()
        {
            ...
            directoryCheckTimer.Interval = 60000;
        ...
        private void KlasorleriVeDosyalariGetir(string anaDizin, string arananKlasor)
        {
            try
            {
                ...
                {
                    string hedefKlasor = klasorler[0]; // İlk bulunan klasörü seçiyoruz.
                    ...
                    foreach (string dosyaYolu in dosyaYollari)
                    {
                        ...
                        // Dosya içeriğini dosyaBilgileri sözlüğüne ekle
        ...
        private Dictionary<string, string> dosyaBilgileri = new Dictionary<string, string>();
        ...
        private string seciliDosyaAdi2 = string.Empty;
        ...
        private void listBox2_MouseUp(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Right)
            {
                ...
                // Sadece sağ tıklama durumunda seçili öğeyi belirle
                if (index != ListBox.NoMatches)
                {
                    // Eğer çoklu seçim yapılmamışsa seçili öğeyi temizle
            ...
            {
                // Sadece sol tıklama durumunda seçimi temizle
                if (!Control.ModifierKeys.HasFlag(Keys.Control))
                {
                    listBox2.ClearSelected();
                }

                // Sadece sol tıklama durumunda seçili öğeyi belirle
                int index = listBox2.IndexFromPoint(e.Location);
                if (index != ListBox.NoMatches)
                {
                    listBox2.SelectedIndex = index;
        ...
        private void TaşıGenel()
        {
            if (listBox2.SelectedItems.Count > 0)
            {
                ...
                try
                {
                    string[] selectedItems = new string[listBox2.SelectedItems.Count];
